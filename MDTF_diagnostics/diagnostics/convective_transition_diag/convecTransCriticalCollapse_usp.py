...
#  DO NOT CHANGE THE VALUES (default: -60 & 30)
...
# ======================================================================
data = {
        "bin_output_list": bin_output_list, "FIG_FILENAME_CTS": FIG_FILENAME_CTS, "FIG_FILENAME_WC": FIG_FILENAME_WC,
        "FIG_OBS_FILENAME_CTS": FIG_OBS_FILENAME_CTS, "FIG_OBS_FILENAME_WC": FIG_OBS_FILENAME_WC,
        "args1": [bin_output_list,
                  TAVE_VAR,
                  QSAT_INT_VAR,
                  BULK_TROPOSPHERIC_TEMPERATURE_MEASURE], "args2": [bin_obs_list,
                                                                    TAVE_VAR,
                                                                    QSAT_INT_VAR,
                                                                    BULK_TROPOSPHERIC_TEMPERATURE_MEASURE],
        "args3": [NUMBER_OF_REGIONS,
                  REGION_STR,
                  FIG_OUTPUT_DIR,
                  FIG_FILENAME_CTS,
                  FIG_FILENAME_WC,
                  ...
                  BULK_TROPOSPHERIC_TEMPERATURE_MEASURE], "fit_model_params": [PDF_THRESHOLD,
                                                                               CWV_RANGE_THRESHOLD,
                                                                               CP_THRESHOLD,
                                                                               CWV_FIT_RANGE_MIN,
                                                                               CWV_FIT_RANGE_MAX,
