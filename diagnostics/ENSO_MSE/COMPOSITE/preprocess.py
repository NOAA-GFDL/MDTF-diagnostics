...
## print os.environ["POD_HOME"] + "/COMPOSITE/NCL_CONVERT/data_routine.ncl"
    ...
    generate_ncl_plots(os.environ["POD_HOME"] + "/COMPOSITE/NCL_CONVERT/data_routine.ncl")
    now = datetime.datetime.now()
    print"  conversion routine finished " + now.strftime("%Y-%m-%d %H:%M") 

    print " NET radiation routine started "
    generate_ncl_plots(os.environ["POD_HOME"] + "/COMPOSITE/NCL_CONVERT/data_radiation_routine.ncl")
    now = datetime.datetime.now()
    print"  NET radiation routine finished " + now.strftime("%Y-%m-%d %H:%M")      

    print " clima routine started "
    generate_ncl_plots(os.environ["POD_HOME"] + "/COMPOSITE/NCL_CONVERT/clima_routine.ncl")
    now = datetime.datetime.now()
