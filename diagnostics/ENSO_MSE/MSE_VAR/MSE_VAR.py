...
mse  = np.zeros((imax,jmax),dtype='float32')
madv = np.zeros((imax,jmax),dtype='float32')
omse = np.zeros((imax,jmax),dtype='float32')
mdiv = np.zeros((imax,jmax),dtype='float32')
tadv = np.zeros((imax,jmax),dtype='float32')

ts_clim   = np.zeros((imax,jmax),dtype='float32')
pr_clim   = np.zeros((imax,jmax),dtype='float32')
shf_clim  = np.zeros((imax,jmax),dtype='float32')
lhf_clim  = np.zeros((imax,jmax),dtype='float32')
sw_clim   = np.zeros((imax,jmax),dtype='float32')
lw_clim   = np.zeros((imax,jmax),dtype='float32')
mse_clim  = np.zeros((imax,jmax),dtype='float32')
madv_clim = np.zeros((imax,jmax),dtype='float32')
omse_clim = np.zeros((imax,jmax),dtype='float32')
mdiv_clim = np.zeros((imax,jmax),dtype='float32')
tadv_clim = np.zeros((imax,jmax),dtype='float32')
...
###########  plot the default domain NINO3.4 bar plots  
	generate_ncl_plots(os.environ["VARCODE"]+ "/ENSO_MSE/MSE_VAR/NCL/plot_bars_composite.ncl")

##      plotting for the  user selected domain :
	generate_ncl_plots(os.environ["VARCODE"]+ "/ENSO_MSE/MSE_VAR/NCL_general/plot_bars_composite.ncl")
...
if os.path.isfile( file ):
	os.system("rm -f "+file)
os.system("cp "+os.environ["VARCODE"]+"/ENSO_MSE/MSE_VAR/MSE_VAR.html "+file)
