...
filein=os.environ["Z200_FILE"]; vname=z200_var
...
if output_opt==1:
   filetxt=WK_DIR+'/model/'+CASENAME+'_tutt_ref.latitude-'+str(iyr1)+'-'+str(iyr2)+smon+'-Ug_'+str(UG_N15_target)+'.txt'
   f0=open(filetxt,'w+')
...
lon0 = ncFid.variables[ lon_coord ][:]
lat0 = ncFid.variables[ lat_coord ][:]
...
#                print(ref_lat0)
            ...
            if output_opt2==1:
               np.savetxt(WK_DIR+'/model/'+CASENAME+'_TUTT_ref_lat_'+str(it+iyr1)+'-Ug_'+str(UG_N15_target)+'.txt',ref_lat_out)
               np.savetxt(WK_DIR+'/model/'+CASENAME+'_TUTT_contour_length_'+str(it+iyr1)+'-Ug_'+str(UG_N15_target)+'.txt',length)
               np.savetxt(WK_DIR+'/model/'+CASENAME+'_TUTT_contour_lon_'+str(it+iyr1)+'-Ug_'+str(UG_N15_target)+'.txt',lonx)
               np.savetxt(WK_DIR+'/model/'+CASENAME+'_TUTT_contour_lat_'+str(it+iyr1)+'-Ug_'+str(UG_N15_target)+'.txt',latx)
...
#output dividing longitude
              ...
              if output_opt2==1:
                 np.savetxt(WK_DIR+'/model/'+CASENAME+'_lat_0_30N.txt',lat_0_30N)
                 np.savetxt(WK_DIR+'/model/'+CASENAME+'_dividing_longitude_'+str(it+iyr1)+'.txt',dividing_longitude)
...
#    lat_grid = np.arange(lat[ilat][0],lat[ilat][-1],20)
    ...
    fig.tight_layout()
#    fig.savefig("TUTT_contour_GFDL.png", format='png',bbox_inches='tight')
    fig.savefig(WK_DIR+"/model/"+CASENAME+"_TUTT_contour_model.png", format='png',bbox_inches='tight')


if output_opt==1:
   fileout=WK_DIR+'/model/'+CASENAME+'_tutt_area-'+str(iyr1)+'-'+str(iyr2)+smon+'-Ug_'+str(UG_N15_target)+'.txt'
   f1=open(fileout,'w+')
   ...
   fileout=WK_DIR+'/model/'+CASENAME+'_tutt_intensity-'+str(iyr1)+'-'+str(iyr2)+smon+'-Ug_'+str(UG_N15_target)+'.txt'
   f1=open(fileout,'w+')
   f1.write('Year            Pac             Atl'+'\n')
   for iy in range(iyr1,iyr2+1):
   ...
   fileout=WK_DIR+'/model/'+CASENAME+'_tutt_UG.wt_lon-'+str(iyr1)+'-'+str(iyr2)+smon+'-Ug_'+str(UG_N15_target)+'.txt'
   f1=open(fileout,'w+')
   f1.write('Year            Pac             Atl'+'\n')
   for iy in range(iyr1,iyr2+1):
   ...
   fileout=WK_DIR+'/model/'+CASENAME+'_tutt_UG.wt_lat-'+str(iyr1)+'-'+str(iyr2)+smon+'-Ug_'+str(UG_N15_target)+'.txt'
   f1=open(fileout,'w+')
   f1.write('Year            Pac             Atl'+'\n')
   for iy in range(iyr1,iyr2+1):
   ...
   fileout=WK_DIR+'/model/'+CASENAME+'_tutt_Area_lon-'+str(iyr1)+'-'+str(iyr2)+smon+'-Ug_'+str(UG_N15_target)+'.txt'
   f1=open(fileout,'w+')
   f1.write('Year            Pac             Atl'+'\n')
   for iy in range(iyr1,iyr2+1):
   ...
   fileout=WK_DIR+'/model/'+CASENAME+'_tutt_Area_lat-'+str(iyr1)+'-'+str(iyr2)+smon+'-Ug_'+str(UG_N15_target)+'.txt'
   f1=open(fileout,'w+')
   f1.write('Year            Pac             Atl'+'\n')
   for iy in range(iyr1,iyr2+1):
