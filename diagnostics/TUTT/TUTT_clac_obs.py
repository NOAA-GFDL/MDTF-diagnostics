#Purpose - Identify TUTT based on geostrophic zonal wind
#Input - 3-D HGT data [time, lat, lon], NetCDF 
...
filein="hgt_1.25_1.25.nc"; vname='hgt'
...
filetxt='tutt_ref.latitude-'+str(iyr1)+'-'+str(iyr2)+smon+'-Ug_'+str(UG_N15_target)+'.txt'
f0=open(filetxt,'w+')
