...
# is either in the POD WK_DIR (multi) or one dir up (single)
...
#============================================================
def generate_html_file_case_loop(f,case_dict): 
...
def generate_html_file_case_single(f): 
    ...
    html_template = "<TD style='width: 200px' align=center><A href=model/block_freq_anncycle.{{CASENAME}}.png>{{CASENAME}}</A>"
    f.write(html_template)
    ...
    html_template = "<TD style='width: 100px' align=center>{{FIRSTYR}} - {{LASTYR}} "
    f.write(html_template)
...
<TR><TD> MDTF_BLOCKING_OBS_CAM5 FIRSTYR - LASTYR  <TD> "{{MDTF_BLOCKING_OBS_CAM5_FIRSTYR}} - {{MDTF_BLOCKING_OBS_CAM5_LASTYR}}"
<TR><TD> MDTF_BLOCKING_OBS_ERA  FIRSTYR - LASTYR  <TD> "{{MDTF_BLOCKING_OBS_ERA_FIRSTYR }} - {{MDTF_BLOCKING_OBS_ERA_LASTYR}}"
<TR><TD> MDTF_BLOCKING_OBS_MERRA  FIRSTYR - LASTYR <TD> "{{MDTF_BLOCKING_OBS_MERRA_FIRSTYR}} - {{MDTF_BLOCKING_OBS_MERRA_LASTYR}}"
