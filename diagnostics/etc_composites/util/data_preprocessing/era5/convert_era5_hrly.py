...
folder = '/localdrive/drive6/era5/data/hrly'   
out_folder = '/localdrive/drive6/era5/data/hrly/converts'
...
for var in var_list:
  ...
  for year in range(year_list[0], year_list[1]+1):
    ...
    fn = os.path.join(folder, f'{var}/{var}_{year}.nc')
    ...
    ds['time'] = np.asarray(np.arange(0, len_time*1, 1), dtype=np.int64)
