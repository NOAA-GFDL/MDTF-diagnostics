...
var_list = ['v', 'u', 'wap']
var_map = {'v': 'va', 'u': 'ua', 'wap': 'wap'}

# # read in model level, convert it to pressure level, Vertical velocity at 500 hpa
# var_list = ['wap']
# var_map = {'wap': 'wap'}
...
for var in var_list:
  ...
  for year in range(2008, 2013):
    ...
    for tstep in tqdm(range(len(time)), total=len(time), desc=f'{var.upper()} {year}: '):
    ...
    # out_ds['time'].attrs['delta_t'] = f'00-00-00 {delta_t:2d}:00:00'
