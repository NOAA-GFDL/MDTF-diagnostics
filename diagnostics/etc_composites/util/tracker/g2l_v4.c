...
static PyMethodDef __pyx_mdef_6g2l_v4_1g2l = {"g2l", (PyCFunction)__pyx_pw_6g2l_v4_1g2l, METH_VARARGS|METH_KEYWORDS, 0};
...
static int __pyx_pymod_exec_g2l_v4(PyObject *__pyx_pyinit_module)
#endif
#endif
{
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init g2l_v4", 0, __pyx_lineno, __pyx_filename);
    }
