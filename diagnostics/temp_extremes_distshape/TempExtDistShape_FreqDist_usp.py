...
### Reanalysis output figure for comparisons (NOT YET CODED BELOW)
...
with open(os.environ["VARCODE"]+"/temp_extremes_distshape/"+"TempExtDistShape_FreqDist_parameters.json", "w") as outfile:
