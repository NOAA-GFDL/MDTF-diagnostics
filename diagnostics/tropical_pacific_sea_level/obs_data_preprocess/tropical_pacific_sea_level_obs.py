...
inputdir = '/storage1/home1/chiaweih/mdtf/inputdata/obs_data/tropical_pacific_sea_level/'
outputdir = '/storage1/home1/chiaweih/mdtf/inputdata/obs_data/tropical_pacific_sea_level/'
...
obs_linear_mlist['WASwind']['curl_tau'].to_netcdf(outputdir+'waswind_curltau_linear.nc')
obs_mean_mlist['WASwind']['curl_tau'].to_netcdf(outputdir+'waswind_curltau_mean.nc')
obs_season_mlist['WASwind']['curl_tau'].to_netcdf(outputdir+'waswind_curltau_season.nc')