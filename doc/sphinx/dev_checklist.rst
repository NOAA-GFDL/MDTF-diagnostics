...
The POD feature must be up-to-date with the NOAA-GFDL develop branch, with no outstanding merge conflicts. See :doc:`dev-git-intro` for instructions on syncing your fork with NOAA-GFDL, and pulling updates from the NOAA-GFDL develop branch into your feature branch.
