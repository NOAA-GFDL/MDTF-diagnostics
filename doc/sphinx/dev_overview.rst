...
:numref:`ref-dev-checklist` Provides a list of instructions for submitting a POD for inclusion in the framework. We require developers to submit PODs through `GitHub <https://github.com/NOAA-GFDL/MDTF-diagnostics>`__. See :doc:`dev-git-intro` for how to manage code through the GitHub website.
