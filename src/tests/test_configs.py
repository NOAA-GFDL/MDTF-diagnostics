...
class TestUtil(unittest.TestCase):
    ...
    #     configs.setenv('TEST_OVERWRITE','B', test_d, overwrite = False)
    ...
    #     test_d = {}
    #     configs.setenv('TEST_STR','B', test_d)
    ...
    #     test_d = {}        
    #     configs.setenv('TEST_INT',2019, test_d)
    ...
    #     try:
    #         configs.check_required_envvar('A', 'C')
    #     except SystemExit:
    #         self.fail()
    ...
    #     self.assertRaises(SystemExit, configs.check_required_envvar, 'A', 'E')
    ...
    def test_check_dirs_found(self, mock_makedirs, mock_isdir):
        ...
        try:
            configs.check_dirs('DUMMY/PATH/NAME', create=False)
            configs.check_dirs('DUMMY/PATH/NAME', create=True)
    ...
    def test_bump_version_delver(self, mock_exists):
        for f in [
            ...
            f1, ver = configs.bump_version(f[0], new_v=0)
    ...
    def test_bump_version_setver(self, mock_exists):
        for f in [
            ...
            f1, ver = configs.bump_version(f[0], new_v=42)
            self.assertEqual(f1, f[1])
            self.assertEqual(ver, 42)
    ...
    #     ]:
    #         f1, ver = configs.bump_version(f[0])
    #         self.assertEqual(f1, f[1])
...
class TestDoubleBraceTemplate(unittest.TestCase):
    def sub(self, template_text, template_dict=dict()):
        tmp = configs._DoubleBraceTemplate(template_text)
